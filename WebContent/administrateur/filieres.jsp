            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        ...
                        <button onclick="window.location.href='filieres?id=${ele.getID_FILIERE()}';", class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light">Voir le Profil</button>
                        <div class="mt-4">
                            <div class="row">
                                <div class="col-4">
                                    <div class="mt-3">
