								...
								<div class="mt-3">
									...
									<div class="button1">
										<c:if test="${exist =='true'}">
											<button
												onclick="window.location.href='download?id=${ens.getID_ENSEIGNANT()}';">Télécharger
												l'emploi du temps</button>
										</c:if>
										<c:if test="${exist =='false'}">
											<button>Emploi non disponible</button>
										</c:if>
					...
					<div class="card mb-3">
						<div class="card-body">
							...
							<div class="row">
								<div class="button2">
									<button
										onclick="window.location.href='enseignant/update?id=${ens.getID_ENSEIGNANT()}&table=enseignants';">Modifier</button>
									<button
										onclick="window.location.href='delete?table=enseignants&id=${ens.getID_ENSEIGNANT()}';">Supprimer</button>
								</div>
							</div>
						</div>
					</div>
